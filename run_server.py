...
def main():
    ...
    print(f"[API]   GET  /api/pending")
    print(f"[API]   GET  /api/pending/latest")
    print(f"[API]   POST /api/email-fields")
    print(f"[API]   POST /api/process")
    print(f"[API]   GET  /api/output-pdf")
    print()
